 ...
 * @returns {Object} OpenRouter service with methods for interacting with OpenRouter API
 */
export function createOpenrouterService(apiKey = process.env.OPENROUTER_API_KEY) {
  ...
  /**
   * Streams a conversation with OpenRouter
   * @param {Object} params - Stream parameters
   * @param {Array} params.messages - Conversation history
   * @param {string} params.promptType - The type of system prompt to use
   * @param {Array} params.tools - Available tools for OpenRouter
  ...
  const streamConversation = async ({
    ...
    const stream = await openrouter.chat.completions.create({
      model: AppConfig.api.providers.openrouter.model,
