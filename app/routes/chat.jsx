...
export async function loader({ request }) {
  ...
  // Authenticate app proxy requests
  if (url.searchParams.has("signature")) {
    const isValid = await authenticateAppProxy(url);
    if (!isValid) {
...
/**
 * Authenticate app proxy requests using HMAC signature verification
 * @param {URL} url - The request URL with query parameters
 * @returns {boolean} True if signature is valid, false otherwise
 */
async function authenticateAppProxy(url) {
  try {
    ...
    console.error("Error authenticating app proxy:", error);
    return false;
  }
}
