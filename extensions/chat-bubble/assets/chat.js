...
(function () {
  ...
  const ShopAIChat = {
    ...
    UI: {
      ...
      init: function (container) {
        ...
        this.elements = {
          ...
          chatOverlay: document.querySelector(".shop-ai-chat-overlay")
        };
      ...
      setupEventListeners: function () {
        ...
        //Chat Overlay 
        chatOverlay.addEventListener('click', () => this.closeChatWindow());
      ...
      toggleChatWindow: function () {
        const { chatWindow, chatInput, chatOverlay } = this.elements;
    ...
    Auth: {
      ...
      startTokenPolling: function (conversationId, messagesContainer) {
        ...
        const poll = async () => {
          ...
          try {
            const appBaseUrl =
              window.shopChatConfig?.appBaseUrl || ShopifyAppURL;
     ...
     */
    Product: {
      addCart: async function (variantId, quantity = 1) {
      ...
      createCard: function (product) {
        ...
        button.addEventListener("click", async function () {
          try {
          await ShopAIChat.Product.addCart(product.variantId);
